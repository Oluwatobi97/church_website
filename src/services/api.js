...
export const attendanceAPI = {
  ...
  create: (day, weekStarting, totalAdults, totalChildren, totalOffering, totalTithes, totalNewcomers, specialProgramme) =>
  ...
  update: (id, day, weekStarting, totalAdults, totalChildren, totalOffering, totalTithes, totalNewcomers, specialProgramme) =>
...
export const timetableAPI = {
  ...
  create: (weekNumber, day, month, year, ministerName) =>
    apiCall('POST', '/timetable', { week_number: weekNumber, day, month, year, minister_name: ministerName }),
  update: (id, weekNumber, day, month, year, ministerName) =>
    apiCall('PUT', `/timetable/${id}`, { week_number: weekNumber, day, month, year, minister_name: ministerName }),
...
export const financeAPI = {
  ...
  createIncome: (category, amount, weekStarting) =>
    apiCall('POST', '/finance/income', { category, amount, week_starting: weekStarting }),

  createExpense: (category, amount, weekStarting) =>
    apiCall('POST', '/finance/expenses', { category, amount, week_starting: weekStarting }),

  updateIncome: (id, category, amount, weekStarting) =>
    apiCall('PUT', `/finance/income/${id}`, { category, amount, week_starting: weekStarting }),

  updateExpense: (id, category, amount, weekStarting) =>
    apiCall('PUT', `/finance/expenses/${id}`, { category, amount, week_starting: weekStarting }),
  ...
  updateBalance: (weekStarting, balanceCarriedDown) =>
    apiCall('PUT', '/finance/balance', { week_starting: weekStarting, balance_carried_down: balanceCarriedDown }),
};
